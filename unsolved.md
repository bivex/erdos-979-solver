...
| Последовательность | Описание | Значения элементов $a(n)$ | Авторы & Ссылки |
| :--- | :--- | :--- | :--- |
| **OEIS [A349764](https://oeis.org/A349764)** | Наименьшее $n$, выразимое $n$ способами через $n$ **РАЗЛИЧНЫХ** $n$-х степеней простых | `2, 410, 8627527, 199898912404` | Ilya Gutkovskiy & Michael S. Branicky (Dec 2021) |
| **OEIS [A385316](https://oeis.org/A385316)** | Наименьшее $n$, выразимое $n$ способами через 3 куба простых | `24, 185527, 8627527, 999979163, 10588881419` | Stijn Cambie (Sep 2025) |
| **OEIS Proposal ([Draft](file:///Volumes/External/Code/erdos-979-solver/oeis_submission.md))** | Наименьшее $n$, выразимое $n$ способами через 4 четвёртые степени простых | `16, 1634, 141339844, 199898912404` | Verified in this Repository |
